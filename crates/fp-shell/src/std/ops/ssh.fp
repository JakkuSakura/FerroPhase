pub const fn keyscan(hostname: str, context hosts: str = "localhost", force: bool = false, port: str = "22", sudo: bool = false) -> bool {
...
pub const fn command(hostname: str, command: str, context hosts: str = "localhost", user: str = "", port: str = "22", sudo: bool = false) -> bool {
    if user == "" {
...
pub const fn upload(hostname: str, filename: str, context hosts: str = "localhost", remote_filename: str = "", port: str = "22", user: str = "", use_remote_sudo: bool = false, ssh_keyscan: bool = false, sudo: bool = false) -> bool {
    if ssh_keyscan {
...
pub const fn download(hostname: str, filename: str, context hosts: str = "localhost", local_filename: str = "", force: bool = false, port: str = "22", user: str = "", ssh_keyscan: bool = false, sudo: bool = false) -> bool {
    if ssh_keyscan {
        std::ops::ssh::keyscan(hostname, hosts=hosts, port=port, sudo=sudo);
    }
    if user == "" {
