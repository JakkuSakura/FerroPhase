...
shell_run 'localhost' "echo local pre-check" '' '' '' ''
shell_run 'web-1' "sudo systemctl restart fp-service" '' '' '' ''
shell_run 'web-1' "sudo journalctl -u fp-service -n 10" '' '' '' ''
shell_run 'web-2' "sudo journalctl -u fp-service -n 10" '' '' '' ''
shell_run 'localhost' "echo local post-check" '' '' '' ''
