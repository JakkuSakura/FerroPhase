generated: crates/fp-shell/examples/runtime-rsync.sh
nged=0
...
local host='web-1'
shell_rsync "${host}" '-az --delete --checksum' './dist/' '/srv/fp-service/dist/' '' '' '' ''
shell_run "${host}" "sudo systemctl restart fp-service" '' '' '' ''
