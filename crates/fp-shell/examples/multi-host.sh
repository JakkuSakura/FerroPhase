generated: crates/fp-shell/examples/multi-host.sh
changed=0
...
shell_run 'web-1' "uname -a" '' '' '' ''
shell_run 'web-2' "uname -a" '' '' '' ''
shell_run 'web-3' "uname -a" '' '' '' ''
shell_run 'web-1' "sudo systemctl status fp-service" '' '' '' ''
shell_run 'web-2' "sudo systemctl status fp-service" '' '' '' ''
shell_run 'web-3' "sudo systemctl status fp-service" '' '' '' ''
